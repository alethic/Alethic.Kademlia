...
namespace Cogito.Kademlia.Fabric.Services
{
    ...
    public class KademliaService : StatelessService
    {
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            var ink = new KEndpointInvoker<KNodeId256, KPeerData<KNodeId256>>(slf, dat, logger: logger);
            var rtr = new KFixedTableRouter<KNodeId256, KPeerData<KNodeId256>>(slf, dat, ink, logger: logger);
            ...
            var kad = new KEngine<KNodeId256, KPeerData<KNodeId256>>(rtr, ink, lup, str, logger: logger);
            var udp = new KUdpProtocol<KNodeId256, KPeerData<KNodeId256>>(2848441, kad, enc, dec, KIpEndpoint.Any, logger);
            var mcd = new KUdpMulticastDiscovery<KNodeId256, KPeerData<KNodeId256>>(2848441, kad, udp, enc, dec, new KIpEndpoint(KIp4Address.Parse("239.255.83.54"), 1283), logger);
